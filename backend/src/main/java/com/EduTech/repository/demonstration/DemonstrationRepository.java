...
public interface DemonstrationRepository extends JpaRepository<Demonstration, Long> { // 실증 상품 관련 레포지토리
	...
	Page<DemonstrationListDTO> selectPageDem(@Param("pageable") Pageable pageable);
	...
	Page<DemonstrationListDTO> selectPageDetailDem(@Param("pageable") Pageable pageable);
	...
	Page<DemonstrationListDTO> selectPageViewDem(@Param("pageable") Pageable pageable);
	...
	Page<DemonstrationListDTO> selectPageViewDemSearch(@Param("pageable") Pageable pageable,
