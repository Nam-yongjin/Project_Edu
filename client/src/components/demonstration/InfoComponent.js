...
const DemInfo = () => {
  ...
  return (
    <section className="max-w-4xl mx-auto my-16 px-8 font-sans text-gray-900">
      <h1 className="text-3xl font-semibold text-gray-900 mb-10 text-center tracking-wide border-b-2 border-indigo-600 pb-3">
        실증 지원 프로그램
      </h1>
