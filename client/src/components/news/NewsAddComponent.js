...
const NewsAddComponent = () => {
    ...
    return (
        <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 max-w-screen-xl mx-auto">
            <div className="max-w-4xl mx-auto mt-4 px-10 p-6 bg-white rounded-xl page-shadow space-y-6">
                ...
                <div>
                    ...
                    <p className="text-gray-500 newText-sm mt-1">
                                ...
                                {imageLoadError && (
                                    <div className="flex items-center justify-center h-48 bg-gray-100 rounded border-2 border-dashed border-gray-300">
                                        <div className="text-center text-gray-500">
                                            <div className="newsText-4xl mb-2">🖼️</div>
