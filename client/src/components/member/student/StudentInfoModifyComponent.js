...
import { readStudent, leaveMember, modifyStudent, checkEmail, checkPhone } from '../../../api/memberApi';
...
const StudentInfoModifyComponent = () => {
...
export default StudentInfoModifyComponent;
