...
import { readTeacher, leaveMember, modifyTeacher, checkEmail, checkPhone } from '../../../api/memberApi';
...
const TeacherInfoModifyComponent = () => {
    ...
    return (
        <div className={`mx-auto ${modifying ? "max-w-screen-md" : "max-w-screen-sm"}`}>
            <div className={`page-shadow min-blank my-10 p-10 space-y-6 text-center`}>
                ...
                <div>
                    <div className="newText-base flex items-center">
                        <label className="w-36 text-left font-medium">학교명<span className='text-red-600' hidden={!modifying}> *</span></label>
                        <input
                            name="schoolName"
                            type="text"
                            placeholder="학교명"
                            ...
                            onChange={handleChange}
                            className="flex-1 input-focus" />
                        {errors.schoolName && <div className="text-red-500 newText-sm text-left ml-36">{errors.schoolName}</div>}
                    </div>
                </div>
...
export default TeacherInfoModifyComponent;
