  ...
  return (
    <section className="bg-white py-16 px-8 font-sans text-gray-900">
      <div className="max-w-4xl mx-auto">
        {/* 제목 */}
        <h1 className="text-3xl font-semibold text-gray-900 mb-10 text-center tracking-wide border-b-2 border-orange-400 pb-3">
          공간 대여 프로그램
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {features.map(({ title, desc }, i) => (
            <div
              key={i}
              className="bg-[#FAF5EF] rounded-xl p-6 shadow-md border border-orange-200 hover:shadow-lg transition-shadow duration-300"
            >
...
export default PlaceRentalInfo;
